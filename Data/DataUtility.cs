...
namespace BugHunterBugTrackerZD.Data
{
    public static class DataUtility
    {
        ...
        {
            // Obtaining the necessary services based on the IService parameter

            //Service: And Instance of Db
            var dbContextSvc = svcProvider.GetRequiredService<ApplicationDbContext>();
            //Service: And Instance of UserManager
            var userManagerSvc = svcProvider.GetRequiredService<UserManager<BTUser>>();
            //Service: And Instance of Configuration Service
            var configurationSvc = svcProvider.GetRequiredService<IConfiguration>();
            //Service: And Instance of RoleManager
            var roleManagerSvc = svcProvider.GetRequiredService<RoleManager<IdentityRole>>();

            // Migration: This is the programmatic equiv. to Update-Database
